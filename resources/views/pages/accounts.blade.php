        ...
        <form method="POST" action="" id="updateBankAccount">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-5">
                    ...
                    <div class="form-group">
                        <label for="transactionCodeInput">Account Name</label>
                        <input type="text" id="ed_account_name" class="form-control" id="transactionCodeInput" aria-describedby="transactionCodeInputHelp" name="name" required value="Omer MEMES" />
                    </div>

                    <div class="form-group">
                        <label for="transactionNarrationInput">Account Number</label>
                        <input type="text" id="ed_account_number" class="form-control" id="transactionNarrationInput" aria-describedby="transactionNarrationInputHelp" name="number" required value="7894561566156" />
                    </div>

                    <div class="form-group">
                        <label>Available Balance</label>
                        <input type="number" id="ed_available_balance" class="form-control" name="available_balance" required value="465" />
                    </div>

                    <div class="form-group">
                        <label>Ledger Balance</label>
                        <input type="number" id="ed_ledger_balance" class="form-control" name="ledger_balance" required value="32131" />
                    </div>
